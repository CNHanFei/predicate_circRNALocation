...
if __name__ == '__main__':
    df_disease = pd.read_excel(r'C:\HJH\circPreTest\pythonProject\feature\circRNA_miRNA_features_128.xlsx', index_col=0)
    df_sim = pd.read_excel(r'C:\HJH\circPreTest\pythonProject\feature\circRNA_miRNA_cell_similarity_matrix.xlsx',header=0,index_col=0)
    ...
    # 指定要保存的CSV文件的路径
    file_path = r'C:\HJH\circPreTest\pythonProject\feature\gate_feature_circRNAAndmiRNA_0.8_128_0.01.csv'
